...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate a Mermaid tree diagram from MNIST latent tree JSON.")
    parser.add_argument("--tree-json", type=str, required=True, help="Path to JSON produced by cluster_mnist_latent_tree.py")
    parser.add_argument("--output", type=str, default="latents/mnist_tree.mmd", help="Output Mermaid file")
...
def main():
    ...
    if assignments is not None:
        # assignments is [num_steps][num_samples]
