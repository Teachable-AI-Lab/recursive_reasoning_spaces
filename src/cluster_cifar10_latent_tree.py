...
def parse_args():
    parser = argparse.ArgumentParser(description="Build a merge tree from CIFAR-10 latents across recursion depths.")
    ...
    parser.add_argument("--save-json", type=str, default="latents/cifar10_latent_tree.json", help="Output JSON path")
...
def main():
    ...
    print("\nPer-step quality vs CIFAR-10 labels:")
